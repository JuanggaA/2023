        ...
        <div class="card-body">
          <form action="" method="post" autocomplete="off">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Nama Product" name="namamenu">
              <p class="" style="font-size: smaller;">Masukan Nama Menu Lengkap Yang Sesuai</p>
            </div>
            <div class="mb-3">
              <label for="formGroupExampleInput2" class="form-label">Harga</label>
              <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Harga Product" name="harga">
            ...
            <div class="mb-3">
              ...
              <select class="form-select" aria-label="Default select example" id="formGroupExampleInput3" name="jenismenu">
                <option selected>Pilih Jenis Menu</option>
                <option value="Hot coffee">Hot Coffe</option>
                <option value="Non Coffee">Non Coffe</option>
