        ...
        <div class="col-sm-10" style="background-color: #F7F7F7;">
          ...
          <section class="mt-3 mx-3">
            <div class="container border rounded">
              <form class="my-3" action="" method="post" autocomplete="off">
                <div class="mb-3 row">
                  <label class="form-label col-2" for="kodePegawai">Kode Pegawai</label>
                  <div class="col-10">
                    <input class="form-control" type="text" name="kodePegawai" id="kodePegawai" placeholder="Input Kode Pegawai" required>
                  </div>
                </div>
                <div class="mb-3 row">
                  <label class="form-label col-2" for="nama">Nama</label>
                  <div class="col-10">
                    <input class="form-control" type="text" name="nama" id="nama" placeholder="Input Nama" required>
                  </div>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-10">
                    <input class="form-control" type="text" name="devisi" id="devisi" placeholder="Input Devisi" required>
                  </div>
                </div>
                <div class="mb-3 row">
                  <label class="form-label col-2" for="tingkatan">tingkatan</label>
                  <div class="col-10">
                    <input class="form-control" type="text" name="tingkatan" id="tingkatan" placeholder="Input tingkatan" required>
                  </div>
                </div>
                <div class="mb-3 row">
                  <label class="form-label col-2" for="jabatan">Jabatan</label>
                  <div class="col-10">
                    <input class="form-control" type="text" name="jabatan" id="jabatan" placeholder="Input Jabatan" required>
                  </div>
                </div>
                <button class="btn offset-2 text-light" type="submit" name="submit" style="background-color: #614FB4;">Tambahkan</button>
                <button class="btn text-light" type="button" name="submit" style="background-color: #614FB4;"><a class="nav-link" href="users.php">Kembali</a></button>
              </form>
            </div>
          </section>
        </div>
